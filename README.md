...
| [Singlestore](https://www.singlestore.com/) [:rocket:](https://www.singlestore.com/careers/jobs/) | Distributed, relational database that handles both transactions and real-time analytics at scale. (formerly MemSQL) | `Lisboa` |
